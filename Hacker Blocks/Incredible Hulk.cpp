...
*   Meanwhile, The Incredible Hulk has to defeat an enemy who is N steps above
...
*   In order to defeat the enemy as quickly as possible he has to reach the Nth step
*   in minimum moves possible. Help Hulk to find the same and contribute in saving the Mother Earth.
*
*   Input Format:
