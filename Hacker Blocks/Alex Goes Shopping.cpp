...
*       the respective price of each item. The third line contains an integer ‘q’
...
*       No
*       Yes
*   Explanation: In query 1, Alex hai 100 units of money.
*   The shopkeeper claims that she can choose to buy from 2 kinds of items ie item 1
*   and item 4 each priced at 100. In query 2, The shopkeeper claims that she can
*   choose to buy from 3 kinds of items ie item 1 and item 4 each priced at
*   100(she can buy 1 from either of the two) or item 2 priced at 200(she can buy one)
*   In query 3, she has 500 units of money. She can either buy item 1 or
*   item 4 ( 5 of each kind respectively). Thus, she has only 2 kinds of items to choose from.
*   In query 5, she has 800 units of money. She can either buy item 1 or
*   item 4 ( 8 of each kind respectively) or item 2(she can buy 4 of these) or item 3(2 of these).
